...
{
    public $prefix = TF::AQUA . "CityBuild" . TF::DARK_GRAY . " | " . TF::WHITE;
    public $pvp = array();
    ...
    public function onJoin(PlayerJoinEvent $event)
    {
        ...
        if ($player->getFirstPlayed()) {
            $player->sendMessage(TF::BOLD . TF::DARK_GRAY . "➤ " . TF::RESET . TF::GREEN . "Herzlich Willkommen auf dem " . TF::YELLOW . "SkyLegit" . TF::GREEN . "Server");
            $player->sendMessage(TF::BOLD . TF::DARK_GRAY . "➤ " . TF::RESET . TF::GREEN . "Erfahre mehr auf unserem Discord unter " . TF::YELLOW . "community-dc.skylegit.tk");
